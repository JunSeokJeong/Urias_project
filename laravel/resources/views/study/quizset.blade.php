...
<script src="https://code.jquery.com/jquery-1.10.2.js"></script>
             ...
             <!--ontimeupdate 재생중일시 해당 함수를 계속 호출함 -->
              ...
              <source src="{{$select->filesrc}}" type="audio/mpeg">
                ...
                <table border="1px">
                 ...
                 <center>
                 <form method="post" action="{{route('quizsend')}}">
               

                <div id="time"></div>
               <h3>등록 할 점자리스트</h3>
                <table border="1px" id="aa">
                    <tr>
                ...
                <input type="button" value="폼에입력" id="up">
                <input type="button" value="확정" id="up2">
                <input type="submit" value="최후전송">
                <input type="button" value="초기화" id="down">
                </form>
                ...
                $("#down").click(function(){
                    ...
                    b=new Array();
                    $('#aa').children().remove();
                    $('#aa').append(' <table border="1px" id="aa"><tr><td>sec</td><td>text</td><td>action</td></tr></table>');
                    alert('초기화완료');
