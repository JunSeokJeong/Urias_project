...
<nav class="navbar navbar-inverse navbar-fixed-top">
       <div class="container-fluid">
              <div class="navbar-header">
                     ...
                     <a><button onclick="mainContent()" alt="본문으로" style="border:0; outline:0; background-color:#00A328 ;color:#00A328;">본문으로</button></a>
       ...
       <ul class="nav navbar-nav">
              ...
              <li class="dropdown"  >
                     <a id="dLabel" href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" role="button" aria-expanded="false" style="color:white;">E-library<span class="caret"></span></a>
                     <ul class="dropdown-menu" role="menu" aria-labelledby="dLabel">
                            <li ><a id="target" href="{{ route('bList') }}">도서목록</a></li>
                            <li><a href="{{ route('mybList') }}" >나의도서목록</a></li>
              ...
              <li class="dropdown">
                     <a id="dLabel" href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" role="button" aria-expanded="false" style="color:white;">Blindcare<span class="caret"></span></a>
                     <ul class="dropdown-menu" role="menu" aria-labelledby="dLabel">
                            <li><a href="{{ route('fallingLocation') }}">낙상사고조회</a></li>
                            <li><a href="{{ route('vCIndex') }}">실시간Q&A 봉사</a></li>
                     </ul>
              </li>
              <li><a href="{{ route('study') }}" style="color:white;" title="온라인 점자 학교" role="button">Online braille shool</a></li>
      ...
      <ul class="nav navbar-nav navbar-right">
        @if (Auth::check())
            ...
            //   $string=explode('@',$text);
                $text = Auth::user()->type.' 사용자입니다.';
              ?>
              <!-- echo $string[0] -->
            <li><a href="#" role="button" style="color:white;"> <?php echo $text ?></a></li>
            @if(Session::has('message'))
                @if(Session::get('message') > 0)
                    <li><a href="{{ route('message') }}" title="{{Session::get('message')}}개의 메세지가 도착했습니다" role="button" style="color:white;" >
                ...
                @else
                <li><a href="{{ route('message') }}" srole="button" tyle="color:white;"><span class="glyphicon glyphicon-envelope"></span></a></li>
                @endif
            @endif
        ...
        @else
            ...
            <li><a href="{{route('register') }}" style="color:white;"><span class="glyphicon glyphicon-user"></span>Sind Up</a></li>
        @endif
      </ul>
    </div>
  </div>
