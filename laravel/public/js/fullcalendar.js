...
Grid.mixin({
	...
	// For "normal" events, this will be identical to the event's start/end, but for "invers0e-background" events,
		...
		return '' +
			'<table>' +
				'<thead class="fc-head">' +
					'<tr>' +
						'<td class="' + this.widgetHeaderClass + '">' +
							this.timeGrid.headHtml() + widgetHeaderClass // render the day-of-week headers
						'</td>' +
					'</tr>' +
				'</thead>' +
				'<tbody class="fc-body">' +
